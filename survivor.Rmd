...
```{r message = FALSE, warning = FALSE}
     ...
     data <- geo_join
      ...
      p <- data %>%
        ...
        ggplot(aes(x = season_number, y = votesAgainst, color = gender)) +
        ...
        ggtitle("Gender and Votes Against Place {current_frame}") +
        labs(subtitle = "Right after the Merge (in finish places 8-12), male contestants are usually\nvoted out") +
